...
main_menu_vip = InlineKeyboardMarkup(row_width=2).add(schedule_button).row(register_button).row(today_button,
                                                                                                tomorrow_button)
admin_main_menu = InlineKeyboardMarkup(row_width=2).add(schedule_button, register_button).row(
